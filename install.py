...
class Install:
    ...
    def __init__(self, url_regexps_remote, install_comment):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", help="List", nargs='?', type=str, default="https://raw.githubusercontent.com/mmotti/pihole-regex/master/regex.list")
    parser.add_argument("--comment", help="Comment", nargs='?', type=str, default="github.com/mmotti/pihole-regex")

    args = parser.parse_args()

    Install(args.list, args.comment)